...
namespace prosper {
	class GLContext;
	class DLLPROSPER_GL GLCommandBuffer : virtual public prosper::ICommandBuffer {
	  public:
	...
	class DLLPROSPER_GL GLCommandBufferPool : public prosper::ICommandBufferPool {
	  public:
	...
	class DLLPROSPER_GL GLPrimaryCommandBuffer : public GLCommandBuffer, public IPrimaryCommandBuffer {
	  public:
	...
	class DLLPROSPER_GL GLSecondaryCommandBuffer : public GLCommandBuffer, public ISecondaryCommandBuffer {
	  public:
